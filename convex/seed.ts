...
const cmsEntries = [
  ...
  },
  {
    ...
    summary: "BHRJ organizes the summit, Interfaith Forcefield manages its delivery, and organizations across South Asia strengthen the work.",
    body: "",
    linkUrl: "/partners",
    order: 10,
    featured: false,
