...
export const dayOne = [
  ...
  ["09:30", "Opening audiovisual", "A visual record of testimony and the summit’s purpose."],
  ["10:00", "Keynote address", "Justice, citizenship and the international responsibility to act."],
  ["11:00", "Panel I · Understand", "History, demographics, constitutional change and documented violence."],
  ["13:00", "Networking lunch", "Delegates, researchers, media and partner organisations."],
  ["14:30", "Panel II · Engage", "Testimony, protection, legal remedies and the seven-point charter."],
  ["16:30", "Day one closing", "Evidence gathered, priorities named and questions carried forward."],
]

export const dayTwo = [
  ["09:00", "Opening presentation", "From evidence to international coordination."],
  ["09:30", "Sessions 1 and 2", "Rapid response, risk assessment and prevention mechanisms."],
  ["11:30", "Tea break", "Informal exchange and bilateral conversations."],
  ["12:00", "Policy roundtable", "Human-rights standards, justice, property rights and legal protection."],
  ["14:30", "Sessions 3 and 4", "Partnerships, early warning, research, media and public awareness."],
  ["16:00", "Paris Declaration", "Adoption of a common agenda and sustained advocacy framework."],
  ["17:00", "Agni Sakshi", "Sacred pledge ceremony witnessed in solidarity."],
  ["17:45", "Closing remarks", "Commitments, next actions and the standing international network."],
]
