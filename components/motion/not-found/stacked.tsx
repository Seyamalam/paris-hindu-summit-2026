...
const CARD =
  "absolute inset-0 rounded-none border border-border bg-card shadow-sm";
    ...
    <NotFoundStage className={className}>
      ...
      >
        ...
        <motion.div
          ...
          transition={SPRING_PANEL}
          className="absolute inset-0 flex flex-col items-center justify-center gap-1 rounded-none border border-border bg-card shadow-md"
        >
